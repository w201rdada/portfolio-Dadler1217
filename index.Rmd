...
library(magrittr)
readLines('https://www.zotero.org/api/users/4665261/collections/GAKEVFFE/items/top?limit=25&format=bibtex&key=6SSHE7PQ08JFRKGSTRT7mvwS&v=1') &>& writeLines('references.bib')
```
